...
import 'package:arenago/views/Modules/ownerModules/owner_notifpage.dart';
import 'package:arenago/views/Modules/ownerModules/owner_search.dart';
import 'package:arenago/views/Modules/ownerModules/owner_updateprofileview.dart';
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const OwnerUpdateProfileView()));
                    },
