...
class _RecentBookingsWidgetState extends State<RecentBookingsWidget> {
  ...
  void initState() {
    ...
    Future<void> _getCurrentUserId() async {
      try
      {
        ...
        const SnackBar(content: Text("Make Sure a Stable Network connection!"), backgroundColor: dangerErrorColor,);
  ...
  Future<List<String>> _fetchArenaNames(List<Map<dynamic, dynamic>> bookings) async {
  ...
  Widget build(BuildContext context) {
    return !hasBooking ? const SizedBox(height: 0, width:0,) :SizedBox(
      height: 150,
